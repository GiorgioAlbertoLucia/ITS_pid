...
if __name__ == '__main__':
    ...
    input_file_eta_cut = '/home/galucia/ITS_pid/output/LHC22o_pass7_minBias_small/bethe_bloch_parametrisation_small_phi.root'
    ...
    g_Pr_phi_cut = inFile_eta_cut.Get('clsize_vs_beta_Pr/clSizeCosL_vs_beta_Pr_sig_points')
    obj_setter(g_Pr_phi_cut, title='Protons, #phi < 0.5', marker_color=kOrange, marker_style=20, marker_size=1.5)
    ...
    obj_setter(BB_Pr, title='Protons, no cut', line_color=kBlue)
    ...
    obj_setter(BB_Pr_eta_cut, title='Protons, #phi < 0.5', line_color=kRed)
    BB_Pr_eta_cut.SetParameters(-3.86731e-01,
                                3.75847e+01,
                                7.79582e+00,
                                2.87779e+00,
                                2.83400e+01)
    ...
    c.SaveAs('clsize_vs_beta_Pr_phi.pdf')