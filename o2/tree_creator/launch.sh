...
o2-analysis-lf-cluster-studies-tree-creator -b --configuration json://configuration.json |
...
o2-analysis-lf-lambdakzerobuilder -b --configuration json://configuration.json | 
...
o2-analysis-pid-tof -b --configuration json://configuration.json | 
